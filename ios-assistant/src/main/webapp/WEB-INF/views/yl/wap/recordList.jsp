...
<div class="depot-option">
    <div class="depot-type" style="margin:0px 20px -5px 0px;height: 40px;">
        <div class="depot-left imitate_select sort_select_05 select_result" style="width: 110px;">
            <input type="text" class="input_text Imitate_select_text" style="padding: 0 8px;width: 92px;"
        ...
        <div class="depot-left">
            关键字：
            <input class="input-text-1 input-height-28 input-100" id="keywords" value="关键字、链接" >
        </div>
        <div class="depot-left margin-5">
            <a class="tzs-btn btn-large dark-blue" id="search">搜索</a>
        </div>
        <div class="depot-left" style="margin-top:11px;">
            共 <span class="b-red" id="record_list_count">0</span> 个宝贝
        </div>
    </div>
</div>
<table class="item-table depot-tab ck-table" cellpadding="0" cellspacing="0" width="795" style="margin:0;margin-top:-1px;" id="taskList_container">
