...
<%@ include file="../../common/filtModuleDemo.jsp" %>
    ...
    <div class="step-2-content">
        <div class="depot-left imitate_select sort_select_07 select_result margin-10">
        ...
        <div class="search">
            <form>
                    <span class="keyword">
                        <input type="text" value="输入宝贝关键字或链接" id="search-key">
                    </span>
    ...
    <!--宝贝信息开始-->
    <table id="itemList" class="item-table" cellpadding="0" cellspacing="0" width="970" style="">
        <thead><tr>
        ...
        <tr>
            <th align="left" width="40">选择</th>
            <th align="left" width="300">宝贝名称 </th>
            <th align="left" width="200">操作时间</th>
            <th align="left" width="150">状态</th>
            <th align="left" width="150">编辑</th>
        </tr>
        </thead>
        <tbody>
