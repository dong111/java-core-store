(function ($) {
    ...
    }, messages: {required: "必填字段.", remote: "Please fix this field.", email: "请输入正确的邮箱地址.", url: "请输入正确的网址.", date: "请输入日期.", dateISO: "请输入标准日期 (ISO).", number: "请输入数字.", digits: "请输入整数.", creditcard: "Please enter a valid credit card number.", equalTo: "请输入相同值.", maxlength: $.validator.format("输入字符数不能超过{0}."), minlength: $.validator.format("输入字符数至少为{0}."), rangelength: $.validator.format("字符长度必须在{0}-{1}."), range: $.validator.format("输入范围必须为{0} - {1}."), max: $.validator.format("输入值大小不能超过{0}."), min: $.validator.format("输入值至少为{0}.")}, autoCreateRanges: false, prototype: {init: function () {
